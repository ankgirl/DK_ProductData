...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function processOrderDetails(orderDetails, batch) {
        ...
        for (let productOrderNumber in orderDetails.ProductOrders) {
            ...
            //itemcount += orderData.상품수량;            
            console.log("할인율: "+orderData.할인율);
            console.log("서비스를위한총결제금액: "+orderDetails.서비스를위한총결제금액);
            console.log("서비스를위한총원가금액: "+orderDetails.서비스를위한총원가금액);
            console.log("총원가금액: "+orderDetails.총원가금액);
        }
        ...
        console.warn("==========================");
        //orderDetails.서비스제품금액 = Math.floor((orderDetails.총결제금액 - orderDetails.총원가금액) * 0.8 / 10) * 10;
